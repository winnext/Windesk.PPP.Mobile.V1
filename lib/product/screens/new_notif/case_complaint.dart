...
@RoutePage()
class CaseComplaintPage extends StatelessWidget {
  CaseComplaintPage({super.key, required this.issueCode});
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField(
                        ...
                        items: [
                          'Seçiniz',
                          'Yerine getirilmediği halde Düzeltildi olarak kapatıldı',
                          'Eksik ya da hatalı yerine getirildi'
                        ].map((String items) {
                        ...
                        onChanged: (newValue) {
                          if (newValue ==
                              'Yerine getirilmediği halde Düzeltildi olarak kapatıldı') {
                            newNotifProvider.setSelectedCallType = 'notfixed';
                          } else if (newValue ==
                              'Eksik ya da hatalı yerine getirildi') {
                            newNotifProvider.setSelectedCallType = 'wrongfixed';
                          }
                          print(newNotifProvider.selectedCallType);
                    ...
                    CustomHalfButtons(
                        ...
                        rightOnPressed: () async {
                          newNotifProvider.addIdariCallInfo2(
                              context, issueCode);
                        })
                  ],
                ),
