...
class IssueSummaryScreen extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    issueSummaryRow(LocaleKeys.cfgInfo,
  ...
  Column _fixWidget(IssueProvider issueProvider) {
    return issueProvider.issueSummaryTimeInfo.statuscode == LocaleKeys.oPlanned
        ? const Column()
        : Column(children: [
            ...
            ? Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(TimeClass().timeRecover(
                        issueProvider.issueSummaryTimeInfo.planneddate)),
                  ],
                ),
              )
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(title),
          Text(
            TimeClass().timeRecover(
                respondedTimer == LocaleKeys.zeroStr ? fixedDate : targetDate),
