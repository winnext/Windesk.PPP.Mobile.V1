...
class IssueSummaryScreen extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    issueSummaryRow(issueProvider.issueSummaryDetail.code, issueProvider.issueSummaryDetail.idate.toString()),
                    ...
                    issueSummaryRow(
                        LocaleKeys.targetResponsed, TimeClass().timeRecover(issueProvider.issueSummaryDetail.targetRdate.toString()).toString()),
                    issueSummaryRow(
                        LocaleKeys.targetFixed, TimeClass().timeRecover(issueProvider.issueSummaryDetail.targetFdate.toString()).toString()),
  ...
  Column _fixWidget(IssueProvider issueProvider) {
    return issueProvider.issueSummaryTimeInfo.statuscode == LocaleKeys.oPlanned ? const Column() : Column(children: [
            ...
            ? Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(TimeClass().timeRecover(issueProvider.issueSummaryTimeInfo.planneddate)),
                  ],
                ),
              )
