...
import 'package:wm_ppp_4/feature/models/work_space/work_space_state.dart';
import 'package:wm_ppp_4/feature/models/work_space/work_space_task.dart';
...
class WorkSpacePendiks extends Equatable {
  ...
  factory WorkSpacePendiks.fromJson(Map<String, dynamic> json) =>
      _$WorkSpaceAppendingsFromJson(json);
