...
class ServiceTools {
  ...
  //// ESH PREPROD
  static const PPP_PROJECT = "esh";
  static const BASE_URL_V2 = 'http://windeskmobiletest.eskisehir.yerel';
  static const TOKEN_V1 = 'wdeshtest!_';
  static const TOKEN_V2 = 'eshtest!';
  static const ATTACHPATHLIVE = "http://10.126.12.21/esh/xreadattach.php?token=${TOKEN_V1}&id=";
  static const base_url_v1 = 'http://10.126.12.21/esh/app/webroot/integration/WindeskMobile.php?use_rest=1&wsusername=' +
      'wdmobile' +
      '&wspassword=' +
      'wdsgnm1017_' +
      '&token=';
